---
title: "Tidy Evaluation (for Shiny apps)"
...
For my data science lectures, I want to be able to run small Shiny apps (e.g. to demonstrate `dplyr` concepts).  With my current knowledge of Shiny code, I am rather sure that I will need the notion of *tidy evaluation* to carry out the following demonstration:
